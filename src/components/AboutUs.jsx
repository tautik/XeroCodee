...
const AboutUs = () => {
  return (
    <div className="flex w-[80%] m-auto h-[100vh] ">
      <div className="w-[60%] pl-10 -z-10 bg-amber-300 flex flex-col justify-center">
      ...
      <img className="relative z-10  w-[40rem]" src={AboutUsImg} alt="" />
      {/* </div> */}
    </div>
  );
};
